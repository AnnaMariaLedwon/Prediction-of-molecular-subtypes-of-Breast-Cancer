...
genes <- read.csv("PAM50_proteins.csv")
...
pdf("BC_missingData.pdf") #print plot to pdf
...
ggsave('BC_subtypes_barplot.pdf')
...
ggsave('BC_LassoProteins_lassoRegression.pdf')
...
ggsave("Lasso_proteins_boxplot.pdf", width = 70, height = 100, units = "cm")
...
plot_grid(plotlist = plot_list,ncol = 5, nrow = 10)
ggsave("Lasso_proteins_violinplot.pdf", width = 70, height = 100, units = "cm")
...
write.table(stab_var.biomart, "Lasso_proteins.csv", sep = ',', row.names = F)
...
ggsave('Lasso_train&testData.pdf')
...
sink("Lasso_SVM_results.txt", append =TRUE) #write output to file
...
sink("Lasso_RandomForest_results.txt", append =TRUE) #write output to file
...
sink("Lasso_NeuralNetworkClassifier_results.txt", append =TRUE) #write output to file
...
ggsave('PAM50_train&testData.pdf')
...
ggsave("PAM50_proteins_boxplot.pdf", width = 70, height = 100, units = "cm")
...
plot_grid(plotlist = plot_list,ncol = 5, nrow = 9)
ggsave("PAM50_proteins_violinplot.pdf", width = 70, height = 100, units = "cm")
...
sink("PAM50_SVM_results.txt", append =TRUE) #write output to file
...
sink("PAM50_RandomForest_results.txt", append =TRUE) #write output to file
...
sink("PAM50_NeuralNetworkClassifier_results.txt", append =TRUE) #write output to file
